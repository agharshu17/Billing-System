...
class ExistingBroker extends StatefulWidget {
  final String email;
  const ExistingBroker({Key key, this.email}) : super(key: key);
  @override
  _ExistingPartyState createState() => _ExistingPartyState();
}

class _ExistingPartyState extends State<ExistingBroker> {
  var values, name;
  var stringvalues;
  @override
  void initState() {
  ...
  showAlertDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      title: Text("Delete the Broker"),
      content: Text("Are you sure you want to delete the broker?"),
      actions: [
        cancelButton,
        continueButton,
      ],
